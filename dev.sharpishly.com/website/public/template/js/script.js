...
app.menu = {
  'Home': {'url':app.url('home/index')},
  'Todo': {'url':app.url('todo/index/0/10')},
//   'Funding': {'url':app.url('funding/records/1')},
//   'Sharpishly': {'url':app.url('sharpishly/index/1')},
//   'Customerlover': {'url':app.url('customerlover/index/1')},
  'Interviews': {'url':app.url('interviews/index')},
  'Sample': {'url':app.url('sample/index/1')},
