...
class BlogModel extends Model {
    ...
    public function main($data,$models){
		...
		$data = $this->set($data,'tbl','migrate_blog');

		$data = $this->set($data,'tbl_notes','migrate_blog_notes');
		...
		$data = $this->blog($data,$models,$options);
	...
	public function blog($data,$models,$options){
