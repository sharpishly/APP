...
class EmailModel extends Model {
	...
	public function test_mail(){
		...
		if (mail($to, $subject, $message, $headers)) {
			echo '✅ Mail sent successfully. Check your inbox or spam.';
		} else {
			echo '❌ Mail failed. Your server may not be configured.';
		}		
	}
    ...
    {
		try {
			$to = 'paultypekoce@gmail.com';
			$subject = 'Welcome to Sharpishly';
			$message = '<b>Hello</b>'; // HTML content
			$from = 'noreply@sharpishly.com';
			$isHtml = true;
