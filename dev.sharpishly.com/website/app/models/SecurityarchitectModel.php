...
class SecurityarchitectModel extends Model {

    public function main($data,$models){

        $options = [];

		$data = $this->set($data,'tbl','migrate_securityarchitect');

		$data = $this->set($data,'tbl_notes','migrate_securityarchitect_notes');
